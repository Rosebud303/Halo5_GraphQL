                  ...
                  <div className='id-left-content-container'>
                    <div className='id-left-images-container'>
                      <div className='id-left-images'>
                        <img className='id-left-pics' alt='Credit Card Chip' src='https://i.imgur.com/NWlB6Wd.jpg' />
                      </div>
                      <div className='id-left-images'>
                        {currentImgUrlEmblem ? (
                          <img
